...
from backend.api.routes import auth, deliveries, health, osrm, routes, simulations, trucks, users
...
api_router.include_router(simulations.router, prefix="/simulations", tags=["Simulation & Analytics"])
